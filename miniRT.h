...
int		check_alight(t_list *);
int		check_cam(t_list *);
...
t_inter	sphere_iter(t_list *sphere_list, t_vec3 cam_o, t_vec3 d, t_inter inter_min);
...
t_inter	plane_iter(t_list *plane_list, t_vec3 cam_o, t_vec3 d, t_inter inter_min);
...
int		rgb_to_int(unsigned char rgb0, unsigned char rgb1, unsigned char rgb2);
...
t_inter	plane_iter_light(t_list *plane_list, t_vec3 cam_o, t_vec3 d, t_inter inter_min);
